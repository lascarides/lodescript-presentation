...
class PiecesControllerTest < ActionController::TestCase
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post :create, piece: { content: @piece.content, equivalent: @piece.equivalent, organization: @piece.organization, predicate: @piece.predicate, thing: @piece.thing }
    end
  ...
  test "should update piece" do
    patch :update, id: @piece, piece: { content: @piece.content, equivalent: @piece.equivalent, organization: @piece.organization, predicate: @piece.predicate, thing: @piece.thing }
    assert_redirected_to piece_path(assigns(:piece))
  end
